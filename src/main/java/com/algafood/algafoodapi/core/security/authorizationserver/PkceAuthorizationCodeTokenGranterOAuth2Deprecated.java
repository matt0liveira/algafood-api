...
// public class PkceAuthorizationCodeTokenGranterOAuth2Deprecated extends
// AuthorizationCodeTokenGranter {

// public
// PkceAuthorizationCodeTokenGranterOAuth2Deprecated(AuthorizationServerTokenServices
// tokenServices,
// AuthorizationCodeServices authorizationCodeServices, ClientDetailsService
...
// OAuth2Authentication authentication = super.getOAuth2Authentication(client,
// tokenRequest);
// OAuth2Request request = authentication.getOAuth2Request();

// String codeChallenge = request.getRequestParameters().get("code_challenge");
// String codeChallengeMethod =
// request.getRequestParameters().get("code_challenge_method");
...
// {
// throw new InvalidGrantException(codeVerifier + " does not match expected code
// verifier.");
// }
// }
...
// private boolean validateCodeVerifier(String codeVerifier, String
// codeChallenge,
// String codeChallengeMethod) {
...
// } else {
// throw new InvalidGrantException(codeChallengeMethod + " is not a valid
// challenge method.");
// }
