...
public interface FluxoPedidoControllerOpenApi {
    ...
    public void confirmar(@ApiParam(value = "CODIGO do pedido") String codigo);
    ...
    public void entregar(@ApiParam(value = "CODIGO do pedido") String codigo);
    ...
    public void cancelar(@ApiParam(value = "CODIGO do pedido") String codigo);
}
